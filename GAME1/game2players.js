document.addEventListener("DOMContentLoaded",()=> 
{
    ...
    function checkForMatch()
    {
        ...
        flag  = true;
        //console.log("Length of Player1 array:"+cardsWonPlayer1.length)
        //while (i<cardsWonPlayer1.length){
        ...
        {     
            while (currentPlayer == 1)
            {
                ...
                while(currentPlayer == 2)
                {
                    ...
                    break;
                } //end of Player 2 loop
            } //end out Outer Loop
        }// closing of function checkForMatch
        ...
        if(cardsWonPlayer1.length === cardArray.length/2)
        {
            resultDisplay1.textContent = "Congratulations Player 1! You won!"
        }
        else if(cardsWonPlayer2.length === cardArray.length/2)
        {
            resultDisplay2.textContent = "Congratulations Player 2! You won!"
        }
    }
})    
