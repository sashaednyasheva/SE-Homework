...
export default class UpdateEventComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    updateEvent = (e) => {
        ...
        EventService.updateEvent(eventObj, this.state.id).then( res => {
        ...
        return (
                   ...
                   <Card border="primary" style={{width: '50rem'}} className = "card col-md-6 offset-md-3 offset-md-3">
                    <Card.Img variant="top" src={Image} style={{marginTop: '8px'}}/>
                        <Card.Header>UPDATE YOUR EVENT</Card.Header>
                        <Card.Body>
                        <Form>
                            <Row className="mb-3">
                                          <Form.Group as={Col} controlId="formGridEventName">
                                            <Form.Label>Event Name</Form.Label>
                                            <Form.Control type="event_name" value={this.state.eventName} onChange={this.changeEventNameHandler}/>
                                          </Form.Group>
                                          <Form.Group as={Col} controlId="formGridEventName">
                                            <Form.Label>Invoice #</Form.Label>
                                            <Form.Control type="invoice_num" value={this.state.invoiceNumber} onChange={this.changeInvoiceNumberHandler}/>
                                          </Form.Group>  
                                        </Row>  

                                        <Form.Group className="mb-3" controlId="formGridEventDescription">
                                            <Form.Label>Event Decription</Form.Label>
                                            <Form.Control type="description" value={this.state.eventDescription} onChange={this.changeEventDescriptionHandler}/>
                                        </Form.Group>
                                        ...
                                        <Button variant="outline-info" onClick={this.updateEvent}>SUBMIT</Button>
